...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    if (result["profilepic"]){
      result["profilepic"] = result["profilepic"].replace('"','');
      result["profilepic"] = result["profilepic"].replace('"','');
    }
    ...
    if (licenses.length == 0 || licenses.length == undefined) {
      var licenseTypes = ['license_bike', 'license_car', 'license_truck', 'license_pistol', 'license_shotgun', 'license_smg', 'license_ar'];
    ...
    /* } else if (eventData.type == "bulletin") {
      ...
      $.each(table, function (index, value) {
        ...
        if (LastName == value.name) {
          ...
          if (DispatchNum == 1) {
            if (value.profilepic){
              value.profilepic = value.profilepic.replace('"','');
              value.profilepic = value.profilepic.replace('"','');
            }
            $(".dispatch-items")
